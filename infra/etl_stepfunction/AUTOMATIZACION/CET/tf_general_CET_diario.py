    ...
    def __init__(self, scope: Construct, id: str, *, props: EtlTfGeneralCETDiarioConstructProps) -> None:
        ...
        glue.CfnJob(
            ...
            command={
                "name": "glueetl",
                "pythonVersion": "3",
                "scriptLocation": f"s3://{scripts_bucket.bucket_name}/AUTOMATIZACION/CET/etl_raw_cet.py",
            },
        ...
        glue.CfnJob(
            ...
            command={
                "name": "glueetl",
                "pythonVersion": "3",
                "scriptLocation": f"s3://{scripts_bucket.bucket_name}/AUTOMATIZACION/CET/etl_raw_to_master_tra_cet.py",
            },
            execution_property={"maxConcurrentRuns": 3},
            default_arguments={
                "--enable-glue-datacatalog": "",
        ...
        glue.CfnJob(
            ...
            command={
                "name": "glueetl",
                "pythonVersion": "3",
                "scriptLocation": f"s3://{scripts_bucket.bucket_name}/AUTOMATIZACION/CET/etl_master_to_analytics_load_cet.py",
            },
            execution_property={"maxConcurrentRuns": 3},
            default_arguments={
                "--enable-glue-datacatalog": "",
