...
@dataclass
class EtlSfAdlsFaboGestionClienteConstructProps:
    environment: str
...
class EtlSfAdlsFaboGestionClienteConstruct(Construct):
    def __init__(self, scope: Construct, id: str, props: EtlSfAdlsFaboGestionClienteConstructProps) -> None:
        ...
        run_gestioncliente.add_catch(notify_finandina_fail, result_path=sfn.JsonPath.DISCARD)
        ...
        has_tables.otherwise(ingest_map.next(run_gestioncliente))
